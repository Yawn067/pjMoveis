  ...
  return (
    <main className="home">
      ...
      <section className="home-produtos">
        ...
        <Carousel className="home-produtos-carousel" listaProdutos={listaProdutos} />
        <Link to="/produtos" className="home-produtos-button">Ver Todos os Produtos</Link>
      </section>
      ...
      <section className="home-depoimentos">
        ...
        <div className="home-depoimentos-list">
          <div className="home-depoimento-item">
            <p>"A PJMóveis transformou minha casa! Móveis de alta qualidade e atendimento excelente."</p>
            <span>- Maria S.</span>
          </div>
          <div className="home-depoimento-item">
